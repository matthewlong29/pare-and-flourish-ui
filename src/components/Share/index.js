    ...
    return (
      <div className='social-links'>
        ...
        <GooglePlusShareButton url={url}>
          ...
          <GooglePlusShareCount url={url}>{count => <div className='share-count'>{filter(count)}</div>}</GooglePlusShareCount>
        </GooglePlusShareButton>
        ...
        <LinkedinShareButton url={url} title={title} description={excerpt}>
          ...
          <LinkedinShareCount url={url}>{count => <div className='share-count'>{filter(count)}</div>}</LinkedinShareCount>
        </LinkedinShareButton>
